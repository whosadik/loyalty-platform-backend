...
class ReportRoadmapQualityMlRuntimeTests(TestCase):
    ...
    def test_runtime_paths_always_write_meta_ml_decision(self):
        ...
        self.assertTrue(str(ml_meta.get("model_version") or "").strip())
        self.assertIn("selected_feature_set", ml_meta)
        self.assertIsInstance(ml_meta.get("shadow"), dict)
        self.assertTrue(str((ml_meta.get("shadow") or {}).get("reason") or "").strip())
        ...
        self.assertTrue(str(ml_meta_updated.get("model_version") or "").strip())
        self.assertIn("selected_feature_set", ml_meta_updated)
        self.assertIsInstance(ml_meta_updated.get("shadow"), dict)
        self.assertTrue(str((ml_meta_updated.get("shadow") or {}).get("reason") or "").strip())
