...
class AdminOverviewTests(APITestCase):
    ...
    def test_admin_overview_has_dashboard_sections(self):
        ...
        self.assertIn("top_offers", r.data)
        self.assertIn("top_categories", r.data)
        self.assertIn("alerts", r.data)
        self.assertIn("recommended_actions", r.data)
        ...
        self.assertEqual(len(r.data["trend"]), 2)
        self.assertGreaterEqual(len(r.data["top_offers"]), 1)
        self.assertGreaterEqual(len(r.data["top_categories"]), 1)
        self.assertIn("7d", r.data["kpis"])
        self.assertIn("30d", r.data["kpis"])
        self.assertIn("90d", r.data["kpis"])
        self.assertEqual(r.data["top_offers"][0]["type"], "campaign")
