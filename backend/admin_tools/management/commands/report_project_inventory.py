        ...
        lines.append(
            _markdown_table(
                ...
                [
                    ...
                    ["/api/me/recommendations", "backend/recs_app/views.py::MeRecommendationsView", "category/product_type/limit/algo", "RecommendationEvent impression", "reranker A/B + guardrail"],
                    ["/api/me/recommendations/bundle", "backend/recs_app/views.py::MeBundleView", "product_id/limit/algo", "RecommendationEvent impression", "reranker A/B + guardrail"],
