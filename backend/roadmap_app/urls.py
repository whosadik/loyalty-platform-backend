...
from roadmap_app.views import (
    MeRoadmapRefreshView,
    MeRoadmapStepClickView,
    MeRoadmapStepPatchView,
    MeRoadmapView,
)
...
urlpatterns = [
    ...
    path("me/roadmap/steps/<int:step_id>/click", MeRoadmapStepClickView.as_view(), name="me-roadmap-step-click"),
]
