...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-version", type=str, default="roadmap_live_transition_planner_v1")
...
def main() -> None:
    ...
    manifest: dict[str, object] = {
        "task": "roadmap_live_transition_planner_multiclass",
    ...
    for scheme in split_schemes:
        scheme_root = model_root_for_scheme(model_root, scheme)
        ...
        for category in categories:
            ...
            metadata = {
                "task": "roadmap_live_transition_planner_multiclass",
                "planner_mode": "live_supervised_transition",
                "model_version": str(args.model_version),
                "category": category,
                "action_space": list(bundle["action_space"]),
            ...
            print(
                "[train_roadmap_live_transition_planner] "
    ...
    print(f"[train_roadmap_live_transition_planner] model_root={model_root}")
