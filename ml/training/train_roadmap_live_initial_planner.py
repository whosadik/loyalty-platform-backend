...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-version", type=str, default="roadmap_live_initial_planner_v1")
...
def main() -> None:
    ...
    manifest: dict[str, object] = {
        "task": "roadmap_live_initial_planner_multiclass",
    ...
    for scheme in split_schemes:
        ...
        for category in categories:
            ...
            metadata = {
                "task": "roadmap_live_initial_planner_multiclass",
                "planner_mode": "live_supervised_initial",
                "model_version": str(args.model_version),
                "category": category,
                "action_space": list(bundle["action_space"]),
            ...
            print(
                "[train_roadmap_live_initial_planner] "
    ...
    print(f"[train_roadmap_live_initial_planner] model_root={model_root}")
